...
while num < n: 
    ...
    if coord_sys == 'EQUATRIAL':
        #con.radec_move(offx, offy, obs['coordsys'].lower(), off_x=obs['lamdel_off'], off_y=obs['betdel_off'], dcos = offset_dcos)
        pass
    elif coord_sys == 'GALACTIC':
        #con.galactic_move(offx, offy, off_x=obs['lamdel_off'], off_y=obs['betdel_off'], dcos = offset_dcos, offcoord = obs['cosydel'])
        pass
