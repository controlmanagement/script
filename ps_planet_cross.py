...
description = 'Do ps_cross_pointing'
...
obsdir = '/home/amigos/NECST/script/obslist/radio/'
...
if obs['coordsys'].lower() == 'j2000' or obs['coordsys'].lower() == 'b1950':
    print('Please use radio_pointing.py')
    sys.exit()
...
dirname = 'n%s_%s_%s_cross_%s_pointing'%(timestamp ,obs['molecule_1'] ,obs['transiti_1'].split('=')[1],planet_number[planet])
savedir = os.path.join(datahome, name, dirname)
print('Object is ',planet_number[planet])
...
while num < n:
    ...
    while p_n < point_n:
        ...
        con.tracking_end()
        con.planet_move(planet, off_x=off_x, off_y=off_y, offcoord = cosydel, dcos = offset_dcos)
        print('moving...')
...
f1 = os.path.join(savedir,'n%s_%s_%s_cross_%s_pointing.fits'%(timestamp ,obs['molecule_1'] ,obs['transiti_1'].split('=')[1],planet_number[planet]))
f2 = os.path.join(savedir,'n%s_%s_%s_cross_%s_pointing.fits'%(timestamp ,obs['molecule_2'] ,obs['transiti_2'].split('=')[1],planet_number[planet]))
